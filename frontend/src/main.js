...
pluralCaseList.push( {plural: "소비자관리/의류상품", pascal: "소비자관리의류상품"} )

pluralCaseList.push( {plural: "판매자관리/상품관리", pascal: "판매자관리상품관리"} )

pluralCaseList.push( {plural: "관리자지원/서비스운영", pascal: "관리자지원서비스운영"} )
